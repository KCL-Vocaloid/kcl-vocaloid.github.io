...
function LinkCard({url, title, image}:{url:string;title:string;image?:string}){
  return (
    <a 
    href={url} 
    className="flex items-center p-4 w-100 rounded-md hover:scale-105 transition-all mb-3 shadow-lg
    shadow-s transition-shadow duration-300 bg-white">
      <div className="flex w-full text-center">
        ...
        <h2 className="font-semi-bold w-full text-center">{title}</h2>
      </div>
    </a>
  );
}
...
export default function Home() {
    return (
        <div className="flex items-center flex-col justify-center mx-auto w-full mt-5 px-8">
